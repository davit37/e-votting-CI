			...
			<div class="card-content">
				...
				<div class="row">
					<div class="col s12 m12">
						<div class="card-panel center">
							<h5 class="black-text">Waktu votting..</h5>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col s6 m6">
						<div class="card-panel">
							...
							<h5 class="black-text">Jam ->
								<?php echo "".$jam1?>
							</h5>
							<h5 class="black-text">Tanggal ->
								<?php echo "".$tgl1?>
							</h5>
						</div>
					</div>
				...
				<div class="row">
					<div class="col s12">
						<div class="card-action">
							<button class="btn waves-effect waves-light light-blue lighten-1 right" onclick="hapus(<?php echo $id?>)">HAPUS</button>
							<a class="waves-effect waves-light btn light-blue lighten-1 right" href="#modal1" style="margin-right: 10px">EDIT</a>
						</div>
					</div>
				</div>
				<?php }
				...
				<div class="row">
					...
					<div class="col s6 offset-s3 center">
						<div class="card-action">
							<button class="btn waves-effect waves-light light-blue lighten-1 submit" type="submit">Submit</button>
							<button type="button" class="waves-effect waves-light btn light-blue lighten-1" onclick="back()">Batal</button>
						</div>
					</div>
				</div>
				<?php echo form_close();?>
...
<div id="modal1" class="modal">
	<div class="modal-content">
		...
		<div class="row">
			...
			<div class="col s6 offset-s3 center">
				<button class="btn waves-effect waves-light light-blue lighten-1 submit2" type="submit">Submit</button>
			</div>
		</div>
		<?php echo form_close();?>
	</div>
...
<script type="text/javascript">
	$(document).ready(function () {
		$(".submit").click(function (event) {
			...
			jQuery.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/admin/datevoting",
				dataType: 'json',
				data: {
					start: start,
				...
				success: function (res) {
					if (res.hasil == 'true') {
						swal({
										...
										function () {
										window.location.href = "<?php echo site_url('admin/startvoting'); ?>";
										})
	...
	function hapus(id) {
		...
		swal({
				...
				if (result.value) {
					jQuery.ajax({
						type: "GET",
						url: "<?php echo base_url(); ?>" + "index.php/admin/delete_voting",
						dataType: 'json',
						data: {
							id: id
						},
